...
def main():
    ...
    while firstP.hp > 0 and secondP.hp > 0:
        ...
        print("AVALIABLE MOVES : \n{0} --{1}  Details : {2}\n{3} --{4} Details : {5}\n{6} --{7} Details : {8}\n{9} --{10} Details : {11}".format(
            moveNames[0][0], moveValues[0], moveNames[0][1], moveNames[1][0], moveValues[1], moveNames[1][1], moveNames[2][0], moveValues[2], moveNames[2][1], moveNames[3][0], moveValues[3], moveNames[3][1]))
